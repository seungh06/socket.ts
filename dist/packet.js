...
class Packet {
    static GET_HEADER = 0;
    static GET_PAYLOAD_LENGTH_16 = 1;
    static GET_PAYLOAD_LENGTH_64 = 2;
    static GET_MASK_KEY = 3;
    static GET_PAYLOAD = 4;
    static COMPLETE = 5;
    state = Packet.GET_HEADER;
    data;
    size;
    fin;
    rsv1;
    ...
    constructor(data) {
        ...
        if (this.state === Packet.GET_PAYLOAD) {
            ...
            if (this.size < this.payload_length)
                return;
    ...
    static frame(opcode, payload, fin, rsv1, mask) {
